...
<div id="page" class="site">
	...
	<div id="content" class="main-container">
			...
			<div class="page-heading-section">
				<section class="heading-title">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<h1 class="heading-title"><?php echo the_title(); ?></h1>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-12">
								<div class="heading-breadcrumbs" typeof="BreadcrumbList" vocab="https://schema.org/">
		...
		<div class="page-heading-nav-bar">
			<div class="container">
				<div class="row">
				<?php wp_nav_menu( array( 'link_before' => '<span class="link-inner">' , 'link_after' => '</span>') ); ?>
				</div>
			</div>
		</div>
